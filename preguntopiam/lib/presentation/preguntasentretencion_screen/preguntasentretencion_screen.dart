...
class PreguntasentretencionScreen extends StatelessWidget {
  const PreguntasentretencionScreen({Key? key})
      : super(
          key: key,
        );
  ...
  Widget _buildOne(BuildContext context) {
    return Container(
      ...
      child: Row(
        ...
        children: [
          CustomImageView(
            imagePath: ImageConstant.imgBrainentretencion63x65,
            height: 63.v,
            width: 65.h,
            margin: EdgeInsets.only(
              left: 15.h,
